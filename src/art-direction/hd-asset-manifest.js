...
import { RUNTIME_ENGRAVING_ARTWORK } from './runtime-artwork/runtime-artwork-pack.js';
...
function rasterAsset(id,role,family,src,fallbackSrc,presets=['jawa-heritage-floral'],quality='foreground'){
  return Object.freeze({id,role,family,presets,src,fallbackSrc,kind:'image',format:'webp',quality,status:'ready',scalable:false,artworkQuality:'generated-engraving',runtimeSwap:'9.9.2B'});
}
...
export const HD_ASSET_MANIFEST=Object.freeze({
  ...
  'landscape-java-engraving-01':rasterAsset('landscape-java-engraving-01','background','engraved-landscape',RUNTIME_ENGRAVING_ARTWORK.landscape,'/assets/art/landscapes/jawa/landscape-java-engraving-01.svg',['jawa-heritage-floral','jawa-luxury','mountain-heritage'],'background'),
  ...
  'hero-joglo-sepia-01':rasterAsset('hero-joglo-sepia-01','hero','joglo',RUNTIME_ENGRAVING_ARTWORK.joglo,'/assets/art/architecture/joglo/hero-joglo-sepia-02.svg',['jawa-heritage-floral','jawa-luxury','mountain-heritage'],'hero'),
  ...
  'floral-bottom-burgundy-01':rasterAsset('floral-bottom-burgundy-01','foreground-floral','floral-bottom',RUNTIME_ENGRAVING_ARTWORK.floralBottom,'/assets/art/florals/bottom/floral-bottom-burgundy-02.svg',['jawa-heritage-floral','jawa-luxury']),
...
export function auditHdManifest(ids=ROYAL_JOGLO_GARDEN_ASSETS){
  ...
  return {valid:invalid.length===0&&missing.length===0,assets:assets.length,ready:assets.filter(a=>a.status==='ready').length,scalable:assets.filter(a=>a.scalable).length,rasterEngraving:assets.filter(a=>a.artworkQuality==='generated-engraving').length,invalid,missing,ids:[...ids]};
}
