...
function imageLayer(id,role,transform={},motion={}){
  ...
  return {id,kind:'image',role,asset:{src:asset?.src||'',fallbackSrc:asset?.fallbackSrc||'',manifestId:id,quality:asset?.quality||'foreground',format:asset?.format||'svg',delivery:asset?.delivery||null},transform,motion:{preset:motion.preset||'fade-in',durationMs:motion.durationMs||1100,delayMs:motion.delayMs||0,parallax:motion.parallax??transform.depth??0,decorMotion:motion.decorMotion||'',decorDurationMs:motion.decorDurationMs||12000},fidelity:{family:asset?.family,status:asset?.status,scalable:Boolean(asset?.scalable),artworkQuality:asset?.artworkQuality||'vector',optimized:Boolean(asset?.optimized)}};
}
...
export function composeRoyalJogloGarden({names='Anif & Dini',eyebrow='THE WEDDING OF',guest='Tamu Undangan',seed='RJG-001'}={}){
  ...
  return {
    ...
    fidelity:{system:'hd-vector-layered',artworkMode:'generated-engraving-raster-v2-clean',composition:'royal-joglo-garden',tuning:'cleanup-export-optimization-v1',seed,manifestReady:manifest.valid,assetIds:[...ROYAL_JOGLO_GARDEN_ASSETS],optimization:{asyncDecode:true,objectUrlTransport:true,alphaEdgeSafe:true,optimizedRaster:manifest.optimizedRaster}},
    ...
    layers:[
      ...
      imageLayer('tree-frame-left-sepia-01','environment-back',{x:1.5,y:51,width:'42%',opacity:.10,depth:.052},{preset:'fade-right',parallax:.04,decorMotion:'sway',decorDurationMs:24000}),
      imageLayer('tree-frame-right-sepia-01','environment-back',{x:98.5,y:51,width:'42%',opacity:.10,depth:.052},{preset:'fade-left',parallax:.04,decorMotion:'sway',decorDurationMs:24000}),
      imageLayer('arch-jawa-carved-gold-01','ornament-back',{x:50,y:6.2,width:'112%',opacity:.80,depth:.078},{preset:'clip-up',parallax:.035}),
      imageLayer('hero-joglo-sepia-01','hero',{x:50,y:80.5,width:'86%',opacity:.98,depth:.12},{preset:'rise-soft',parallax:.07,decorMotion:'breathe',decorDurationMs:26000}),
      imageLayer('orn-gunungan-gold-01','ornament-front',{x:50,y:21.7,width:'15%',opacity:.82,depth:.15},{preset:'zoom-soft',parallax:.075,decorMotion:'float',decorDurationMs:16000}),
      ...
      imageLayer('floral-side-left-burgundy-01','ornament-front',{x:2.5,y:47,width:'34%',opacity:.12,depth:.19},{preset:'fade-right',parallax:.075,decorMotion:'sway',decorDurationMs:21000}),
      imageLayer('floral-side-right-burgundy-01','ornament-front',{x:97.5,y:47,width:'34%',opacity:.12,depth:.19},{preset:'fade-left',parallax:.075,decorMotion:'sway',decorDurationMs:21000}),
      imageLayer('floral-bottom-burgundy-01','foreground-floral',{x:50,y:92.5,width:'116%',opacity:1,depth:.27},{preset:'fade-up',parallax:.12,decorMotion:'float',decorDurationMs:24000}),
...
export function createRoyalJogloGardenProject(options={}){
  ...
  return {project:{id:`royal-joglo-garden-${String(seed).toLowerCase()}`,name:'Royal Joglo Garden',version:1,preset:'jawa-luxury',seed},theme:{id:'jawa-luxury',palette:{background:'#f1e6ce',surface:'#f8f0df',text:'#76552f',accent:'#a77a42',muted:'#9c7d59'},tokens:{radius:26,motionIntensity:.48,decorIntensity:.74}},variation:{seed,layout:'royal-joglo-garden',heroVariant:'joglo-engraving-raster-clean',backgroundMotion:'zoom-in',motion:{hero:'rise-soft',title:'clip-up',names:'fade-up'},atmosphere:['warm-haze','paper-grain']},fidelity:{mode:'hd-vector-layered',artworkMode:'generated-engraving-raster-v2-clean',composition:'royal-joglo-garden',tuning:'cleanup-export-optimization-v1',manifest},generator:{mode:'fidelity-composer',version:'9.9.3'},audio:{src:'',autoplayAfterOpen:true,loop:true,volume:.72,fadeInMs:1400},scenes:[composeRoyalJogloGarden(options)]};
}
